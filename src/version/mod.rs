...
use futures::{channel::mpsc::{SendError, Sender}, executor::block_on, SinkExt, StreamExt};
use parquet::arrow::{
    ...
    S: Schema,
{
    ...
    async fn read_parquet(
        ...
        let mut file = fs::File::create(option.table_path(scope_gen)).await.map_err(VersionError::Io)?;
